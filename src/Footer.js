        ...
        <div className="container  d-flex flex-column">
           <h4 className="d-flex justify-content-center text-body-secondary">Typology</h4>
            <div className="d-flex text-grey  d-flex justify-content-center">
                <h5 className="text-body-secondary"> Created <span className="text-decoration-underline">By tekla khabeishvili</span> / </h5> 
    ...
    <nav className=" navbar navbar-expand-lg d-flex mt-4  d-block d-md-none " >
        <div className="container-fluid ">
            <div className="container  d-flex flex-column">
                ...
                <div className="d-flex text-grey  d-flex justify-content-center">
                <h6 className="text-body-secondary"> Created <span className="text-decoration-underline">By tekla khabeishvili</span></h6> 
